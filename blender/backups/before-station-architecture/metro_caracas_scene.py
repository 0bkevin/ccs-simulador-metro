...
def build_scene():
    ...
    train_names = [f"CAF car {i:02d}" for i in range(1, 8)]
    ...
    visibility(station_names + ["Linea 1 route", "Altamira Plaza entrance"], False)
    ...
    visibility(station_names + ["Linea 1 route", "Altamira Plaza entrance"], True)
