...
def main():
    ...
    lighting = {'areaLights': area_lights(source_scene)}
    source_depsgraph = source_scene.view_layers[0].depsgraph

    train_objs = source_objects(TRAIN_COLLECTIONS, include_labels=True)
