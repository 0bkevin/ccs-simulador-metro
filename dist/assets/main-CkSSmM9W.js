import{s as pe,O as ue,l as me,W as he,T as ge}from"./style-XWqCGVPU.js";import{c as fe,a as be,p as ne,b as we,d as re,g as ie,e as ve,f as oe,s as ye,h as Ae}from"./station-camera-CNwmih14.js";import{c as Ce,a as Te,b as Ee}from"./train-doors-BjkZJpJS.js";const ke=`# Línea 1 del Metro de Caracas: investigación para el juego
...
`,le={color:"#d71920",realStationCount:22},X=le.color,ze=[{id:"cano-amarillo",name:"Caño Amarillo",distance:0,color:X,type:"elevated",platformLayout:"side",railCenters:[0,4],interchange:null,detail:"Estación elevada junto al antiguo eje ferroviario Caracas–La Guaira, con cubierta reticulada amarilla y andenes laterales."},{id:"capitolio",name:"Capitolio",distance:900,color:X,type:"subterránea",platformLayout:"side",railCenters:[0,4],interchange:"Conexión peatonal con El Silencio (Línea 2)",detail:"Estación profunda del centro con mezzanina y conexión peatonal hacia El Silencio."},{id:"bellas-artes",name:"Bellas Artes",distance:1800,color:X,type:"subterránea",platformLayout:"island",railCenters:[0,10],interchange:null,detail:"Estación profunda con andén central bajo el eje cultural de Bellas Artes."},{id:"plaza-venezuela",name:"Plaza Venezuela",distance:2800,color:X,type:"subterránea",platformLayout:"side",railCenters:[0,4],interchange:"Líneas 3 y 4 (conexiones del complejo)",detail:"Complejo de transferencia con niveles y pasillos de conexión de alta demanda."},{id:"altamira",name:"Altamira",distance:3900,color:X,type:"subterránea",platformLayout:"island",railCenters:[0,10],interchange:null,detail:"Estación de tres niveles bajo la plaza y avenida Francisco de Miranda, con andén central y mezzanina."}],se=ze.map((h,b)=>({...h,...pe.stations[b]}));function Ie(h,b,r=[],u){if(!(u!=null&&u.train)||!(u!=null&&u.environment))throw new Error("Los modelos Blender aún no están disponibles.");const e=new h.Scene,l=fe(e,b,u.manifest),M=be(e);e.fog=new h.Fog(1581354,260,900);const T=new h.Group;T.name="Caracas Metro L1 · Blender export",e.add(T);const y=u.environment;y.name="Blender environment · five stops",T.add(y),ne(y,b);const t=[];y.traverse(n=>{!n.isMesh&&n.userData.sourceCollection&&t.push(n)});const v=r.map(n=>t.find(p=>p.userData.sourceCollection===n.collection));if(v.some(n=>!n))throw new Error("Falta una estación Blender en el entorno del juego.");const c=u.train;c.name="Blender train · 7 cars",T.add(c),ne(c,b),c.traverse(n=>{if(n.isMesh){const p=Array.isArray(n.material)?n.material:[n.material];n.castShadow=p.some(o=>!o.transparent)}});const A=Ce(c),m={forward:new h.PerspectiveCamera(70,1,.05,1200),exterior:new h.PerspectiveCamera(68,1,.1,900),platform:new h.PerspectiveCamera(68,1,.1,900),inspection:new h.PerspectiveCamera(68,1,.2,700),interior:new h.PerspectiveCamera(72,1,.035,700)},E=Te(c,m.interior,b,u.manifest),C=Ee(c);let S="platform",g=null,j=0,I=0;const k=b?new ue(m.inspection,b.domElement):null,x=we({camera:m.inspection,controls:k,environment:y});k&&(k.enabled=!1,k.enableDamping=!1,k.addEventListener("change",()=>{x.adjusting||(x.constrain(),j++)}));const R=()=>g?m.inspection:m[S];function K(n){return S=["forward","exterior","platform","interior"].includes(n)?n:"platform",j++,R()}function G(n=I,p="platform"){n=Math.max(0,Math.min(r.length-1,Number(n)||0));const o=ie(n,p,m.inspection.aspect);g={index:n,...o};for(const z of t)z.visible=o.collections.includes(z.userData.sourceCollection);re(b,o),M.show(n,o.kind);const s=r[n].distance;return c.visible=["platform","detail","concourse"].includes(o.kind)&&c.position.z>=s-148&&c.position.z<=s+150,k&&(k.enabled=!0),x.setView(n,o),l.focus(m.inspection.position,o.collection,o.exterior,["plan","section"].includes(o.kind)),j++,g}function H(){g=null,re(b,{}),M.hide(),k&&(k.enabled=!1),x.clear(),t.forEach(n=>{n.visible=!0}),c.visible=!0,j++}function $(n){(g==null?void 0:g.kind)!=="tunnel"||!Number.isFinite(Number(n))||(x.moveTunnel(n),l.focus(m.inspection.position,g.collection),j++)}function O(n=.016,p=0,o={}){c.position.set(0,0,Number(p)||0),A.update(n,o),C.update(o,A.fraction);const s=c.position.z;m.forward.position.set(0,2.5,s+5),m.forward.lookAt(0,2,s+15);const z=E.cars[E.state.carIndex-1],_=S==="interior"&&z?s+z.center+z.direction*E.state.travel:S==="platform"?s-84:s+4.6;I=r.findIndex(w=>_<=w.distance+5),I<0&&(I=r.length-1);const L=r[I],B=(w,N)=>w>=N.distance-144&&w<=N.distance+4,F=B(_,L),D=["Bellas Artes","Altamira"].includes(L==null?void 0:L.name),W=D?2.5:(L==null?void 0:L.name)==="Capitolio"?-2.65:-3.9;m.platform.position.set(F?W:0,2.73,F?s-84:s+5),m.platform.lookAt(F?W:0,2.98,F?s-69:s+23);const P=r.some(w=>B(s+4.6,w));if(m.exterior.position.set(P?D?7.5:W:0,2.73,s+4.6),m.exterior.lookAt(0,2.1,P?s-4:s+22),E.update(s,S==="interior"&&!g,R().position.z),g)x.constrain(),l.focus(m.inspection.position,g.collection,g.exterior,["plan","section"].includes(g.kind));else{const w=R().position.clone(),N=r.find(a=>w.z>=a.distance-145&&w.z<=a.distance+5),Y=Math.max(0,r.findLastIndex(a=>w.z>a.distance+5));l.focus(w,(N==null?void 0:N.collection)||`Tunnel ${r[Y].id}`)}}function V(n,p){if(Object.values(m).forEach(o=>{o.aspect=n/Math.max(1,p),o.updateProjectionMatrix()}),(g==null?void 0:g.kind)==="plan"){const{index:o}=g,s=ie(o,"plan",m.inspection.aspect);g={index:o,...s},x.setView(o,s)}else x.constrain();j++}function f(){T.traverse(n=>{var p;n.geometry&&n.geometry.dispose(),(p=n.material)!=null&&p.dispose&&n.material.dispose()}),k==null||k.dispose(),x.dispose(),l.dispose(),E.dispose(),C.dispose(),M.dispose()}return{scene:e,root:T,train:c,cameras:m,get camera(){return R()},get inspection(){return g},get activeStation(){return I},get renderRevision(){return j+E.revision+A.revision+C.revision},get doorFraction(){return A.fraction},doors:A,setCameraMode:K,inspectStation:G,leaveInspection:H,moveTunnel:$,update:O,resize:V,dispose:f,controls:k,stationAssemblies:v,railPaths:[],lighting:l,interior:E,cab:C,cameraGuard:x,assetSource:u.source,manifest:u.manifest}}function Me(h=[],{routeEnd:b=1/0}={}){var T,y;const r=((T=h[0])==null?void 0:T.distance)??0,u=Math.max(((y=h.at(-1))==null?void 0:y.distance)??r,b);let e;const l=()=>{var t;return{position:r,speed:0,target:0,doorsOpen:!0,doorSide:((t=h[0])==null?void 0:t.platformLayout)==="island"?1:-1,doorStation:0,lastServed:-1,dwell:3,started:!1,missed:!1,complete:!1,paused:!1,score:100,serviceCount:0}};return e=l(),{get state(){return{...e}},start(){return e.started=!0,this},reset(){return e=l(),e.started=!0,this},pause(t=!e.paused){return e.paused=t,this},setDoors(t){if(t=!!t,t===e.doorsOpen)return this.state;const v=e.doorsOpen?e.doorStation:h.findIndex((A,m)=>(m===e.target||m===e.lastServed)&&Math.abs(e.position-A.distance)<=12),c=h[v];return e.paused||e.speed>.04||!c||Math.abs(e.position-c.distance)>12||e.missed||e.complete?this.state:(t?(e.doorsOpen=!0,e.doorStation=v,e.doorSide=c.platformLayout==="island"?1:-1,e.dwell=v>e.lastServed?3:0):e.dwell<=0&&(e.doorsOpen=!1,v>e.lastServed&&(e.serviceCount++,e.lastServed=v,e.target===h.length-1?e.complete=!0:e.target++)),this.state)},toggleDoors(){return this.setDoors(!e.doorsOpen)},recover(){const t=h[e.target];return!t||e.complete||!e.missed?this.state:(e.position=t.distance,e.speed=0,e.doorsOpen=!0,e.doorStation=e.target,e.doorSide=t.platformLayout==="island"?1:-1,e.dwell=3,e.missed=!1,e.score=Math.max(0,e.score-15),this.state)},tick(t,v={}){if(!e.started||e.paused||e.complete)return this.state;const c=Math.min(Math.max(Number(t)||0,0),.05);e.doorsOpen&&(e.dwell=Math.max(0,e.dwell-c));const A=!!v.throttle&&!e.doorsOpen&&!e.missed;v.emergency?e.speed=Math.max(0,e.speed-3*c):v.brake?e.speed=Math.max(0,e.speed-2.5*c):A?e.speed=Math.min(18,e.speed+1.15*c):e.speed=Math.max(0,e.speed-.22*c),e.position+=e.speed*c,e.position>=u&&(e.position=u,e.speed=0);const m=h[e.target];return m&&e.position>m.distance+12&&!e.missed&&(e.missed=!0,e.score=Math.max(0,e.score-20)),this.state}}}const je=[{title:"Metro De Caracas Compilación Trenes Alstom y CAF",url:"https://www.youtube.com/watch?v=Ej0X90zrtNg",creator:"Dani215 Railway",date:"2024-07-17",license:"No redistributable licence verified on the source page; reference-only",authenticity:"creator's description identifies Line 1 CAF Renfe Serie 6 footage (61047–61080), alongside Alstom footage; no audio copied"},{title:"OpenBVE Venezuela CAF Serie 6 asset pack (external download)",url:"https://www.mediafire.com/file/om2u9qlgt7gaahw/Pack_Series_10000_y_60000_MCCS_FINAL.zip/file",creator:"OpenBVE Venezuela / uploader credited on the pack page",license:"No reuse licence or permission statement found in the page/archive; do not bundle",authenticity:"CAF S6 train asset includes WAV filenames, but the archive does not establish that they are field recordings"},{title:"Caracas Metro compilation (Line 1, 2006–2013)",url:"https://www.youtube.com/watch?v=86YCTUO5gQw",creator:"MonteBRujaFM",license:"No redistributable licence verified on the source page; reference-only",authenticity:"creator describes Caracas Line 1 rolling-stock footage; audio remains copyrighted"},{title:"Caracas Metro 10000 and 20000 series sound examples",url:"https://www.youtube.com/watch?v=gtgx51bclew",creator:"YouTube uploader (linked by r/transit discussion)",license:"No redistributable licence verified on the source page; reference-only",authenticity:"identified as older Caracas Alstom 10000/20000-series stock, not CAF 60000-series; not bundled"},{title:"Caracas Metro 10000 and 20000 series sound example 2",url:"https://www.youtube.com/watch?v=cbB9gqDMQ0o",creator:"YouTube uploader (linked by r/transit discussion)",license:"No redistributable licence verified on the source page; reference-only",authenticity:"identified as older Caracas Alstom 10000/20000-series stock, not CAF 60000-series; not bundled"}],Pe={authenticity:"procedural gameplay fallback; no bundled Caracas recording"},Q=(h,b=0,r=1)=>Math.max(b,Math.min(r,h));function Ne(h,b=2){const r=h.createBuffer(1,h.sampleRate*b,h.sampleRate),u=r.getChannelData(0);let e=0;for(let l=0;l<u.length;l+=1)e=e*.965+(Math.random()*2-1)*.18,u[l]=e;return r}function Oe({now:h=()=>performance.now()/1e3,contextFactory:b=null}={}){let r=null,u=!1,e=.65,l=!1,M=null,T=h(),y=0,t=0,v=[],c=null,A=null,m=[],E=[],C=null,S=null,g=null,j=null,I=null;function k(f,n,p,o=0){const s=r.createOscillator(),z=r.createGain();return s.type=f,s.frequency.value=n,z.gain.value=o,s.connect(z).connect(p),s.start(),v.push(s,z),{osc:s,gain:z}}function x(){if(r||l)return;const f=b||globalThis.AudioContext||globalThis.webkitAudioContext;if(!f)return;r=b?b():new f,c=r.createGain(),c.gain.value=0,A=r.createDynamicsCompressor(),A.threshold.value=-18,A.knee.value=16,A.ratio.value=7,A.attack.value=.008,A.release.value=.18,c.connect(A).connect(r.destination),m=[56,112,168].map((B,F)=>{const D=k(F===1?"triangle":"sine",B,c,0);return E.push(D.gain),D.osc});const n=r.createBufferSource();n.buffer=Ne(r),n.loop=!0;const p=r.createBiquadFilter();p.type="lowpass",p.frequency.value=760,p.Q.value=.45,C=r.createGain(),C.gain.value=0,n.connect(p).connect(C).connect(c),n.start(),v.push(n,p,C),S=r.createGain(),S.gain.value=0;const o=k("sawtooth",145,S,.07),s=r.createBiquadFilter();s.type="bandpass",s.frequency.value=820,s.Q.value=2.1,S.disconnect(),S.connect(s).connect(c),v.push(s,o),g=r.createGain(),g.gain.value=.002,g.connect(c);const z=k("sine",47,g,.6);v.push(z),j=r.createGain(),j.gain.value=0;const _=r.createOscillator(),L=r.createBiquadFilter();_.type="sawtooth",_.frequency.value=1700,L.type="bandpass",L.frequency.value=1350,L.Q.value=2,_.connect(L).connect(j).connect(c),_.start(),v.push(_,L,j),I=r.createGain(),I.gain.value=1,I.connect(c),v.push(I)}const R=(f,n,p=.06)=>{if(!r||!f)return;const o=r.currentTime;f.cancelScheduledValues(o),f.setTargetAtTime(n,o,p)};function K(){if(!r||!u||!j)return;const f=r.currentTime;[660,880].forEach((n,p)=>{const o=r.createOscillator(),s=r.createGain();o.type="sine",o.frequency.value=n,s.gain.setValueAtTime(1e-4,f+p*.16),s.gain.exponentialRampToValueAtTime(.06,f+p*.16+.012),s.gain.exponentialRampToValueAtTime(1e-4,f+p*.16+.22),o.connect(s).connect(I),o.start(f+p*.16),o.stop(f+p*.16+.25)})}function G(f,n={}){const p=Q(Number(f)||0,0,.1);T=h();const o=!!n.doorsOpen;if(M!==o&&M!==null&&(M===!0&&o===!1&&K(),t=1),M=o,!r||!u||l)return;const s=Q((Number(n.speed)||0)/18),z=!!(n.brake||n.emergency);t=Math.max(0,t-p/.8);const L=n.camera==="exterior"||n.cameraMode==="exterior"?.68:1,B=!!n.started&&!n.paused&&!n.complete&&!o,F=!!n.started&&!n.paused&&!n.complete,D=B?L:0;R(c.gain,e*(F?L*(o?.055:.1375+s*.275):0),.08),m.forEach((P,w)=>R(P.frequency,[56,113,171][w]+s*[130,260,390][w],.1));const W=n.throttle?1:.35;if(E.forEach((P,w)=>R(P.gain,D*(.018-w*.003)*(.15+s)*W,.1)),R(C.gain,D*(.018+s*.035),.14),R(S.gain,D*(z?.8:0)*s,.09),R(g.gain,F?L*.012:0,.2),R(j.gain,t*.012,.08),y+=p*(1.5+s*13),B&&s>.03&&y>=1){y%=1;const P=r.createOscillator(),w=r.createGain(),N=r.currentTime;P.type="triangle",P.frequency.value=540+Math.random()*90,w.gain.setValueAtTime(1e-4,N),w.gain.exponentialRampToValueAtTime(Math.max(2e-4,.018*s),N+.004),w.gain.exponentialRampToValueAtTime(1e-4,N+.045),P.connect(w).connect(c),P.start(N),P.stop(N+.05)}}async function H(f){return l?!1:(u=!!f,u&&(x(),r&&r.state==="suspended"&&r.resume&&typeof r.startRendering!="function"&&await r.resume()),r&&R(c.gain,u?e*.001:0,.04),u)}function $(){M=null,y=0,t=0,r&&R(c.gain,0,.04)}function O(f){return e=Q(Number(f)/100,0,1),r&&u&&R(c.gain,e*.001,.04),e*100}function V(){var f;l=!0,u=!1,v.forEach(n=>{var p,o;try{(p=n.stop)==null||p.call(n),(o=n.disconnect)==null||o.call(n)}catch{}}),(f=r==null?void 0:r.close)==null||f.call(r),v=[],r=null}return{setEnabled:H,setVolume:O,update:G,reset:$,dispose:V,status:()=>({enabled:u,available:!!r,running:!!(r&&r.state==="running"),lastUpdate:T})}}async function _e(){var Y;const h=document.querySelector("#app");h.innerHTML='<div class="asset-loading" role="status"><div class="asset-loading-mark">M</div><div class="asset-loading-title">Cargando exportación Blender</div><div class="asset-loading-detail" id="assetLoadingDetail">Validando manifest.json…</div></div>';let b;try{b=await me({onProgress:(a,d)=>{const i=document.querySelector("#assetLoadingDetail");i&&(i.textContent=`${a} · ${Math.round(d*100)}%`)}})}catch(a){const d=String((a==null?void 0:a.message)||a);throw h.innerHTML=`<div class="asset-error" role="alert"><div class="asset-loading-mark">!</div><h1>No se pudo abrir el mundo Blender</h1><p>${d.replace(/[&<>]/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;"})[i])}</p><p>Comprueba que <code>public/models/blender/manifest.json</code>, <code>train.glb</code> y <code>environment.glb</code> estén publicados y vuelve a cargar.</p><button onclick="location.reload()">REINTENTAR</button></div>`,a}const r=(Array.isArray(se)?se:[]).map((a,d)=>{var i;return{...a,...b.manifest.stations[d]||{},distance:Number(((i=b.manifest.stations[d])==null?void 0:i.distance)??a.distance)}});h.replaceChildren();const u=new he({antialias:!0,powerPreference:"low-power"});ve(u),u.setSize(innerWidth,innerHeight),h.append(u.domElement);const e=Ie(ge,u,r,b);e.resize(innerWidth,innerHeight);const l=Me(r,{routeEnd:oe(r.length-1).max-5}),M=Oe();window.__metro={world:e,sim:l,renderer:u,assetSource:b.source,manifest:b.manifest,assetsReady:!0};const T=document.createElement("div");T.className="ui",T.innerHTML=`
